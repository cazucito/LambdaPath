...
//        //
        ...
        //
        System.out.println("|05| Con Expresiones Lambda");
        InvocadorDeOperaciones.invoca(a, b, (int in1, int in2) -> {
            int resultado = 0;
            resultado = in1 * in2;
            System.out.println("\tResultado (" + in1 + " * " + in2 + ") = " + resultado);
        });
        InvocadorDeOperaciones.invoca(a, b, (in1, in2) -> System.out.println("\tResultado (" + in1 + " * " + in2 + ") = " + (in1 * in2)));
        CalculadoraAritmetica resta = (in1, in2) -> System.out.println("\tResultado (" + in1 + " - " + in2 + ") = " + (in1 - in2));
